...
#define HAL_SPIM1_CLK NRF_GPIO_PIN_MAP(0, 13)
#define HAL_SPIM1_MOSI NRF_GPIO_PIN_MAP(0, 12)
#define HAL_SPIM1_MISO NRF_GPIO_PIN_MAP(0, 13)
#define HAL_SPIM1_SS NRF_GPIO_PIN_MAP(0, 14)

#define HAL_SPI_FLASH_RESETN NRF_GPIO_PIN_MAP(0, 9)

#define HAL_BUZZER_PWM NRF_GPIO_PIN_MAP(0, 6)
#define HAL_BUZZER_PWM_CYCLE_COUNT 1000
