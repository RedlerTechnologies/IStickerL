...
#define DEVICE_NAME "IStickerL Power Tester" /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME "Cloud-Wise"       /**< Manufacturer. Will be passed to Device Information Service. */
...
#define FIRST_CONN_PARAMS_UPDATE_DELAY                                                                                                     \
    5000 /**< Time from initiating event (connect or start of notification) to first time sd_ble_gap_conn_param_update is called (5        \
            seconds). */
...
static bool m_rr_interval_enabled = true; /**< Flag for enabling and disabling the registration of new RR interval measurements (the purpose
                                             of disabling this is just to test sending HRM without RR interval data. */
...
int main(void)
{
    ...
    NRF_LOG_INFO("Cloud-Wise FreeRTOS power tester started.");
